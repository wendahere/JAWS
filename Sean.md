...
4. Reading the datasheet for the charging module, I found out that it has battery protection, meaning that it has a measure to deal with overcharging. However, the module battery protection 
5. only works if the battery's voltage has reached 4.2 volts.




<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MDg2ODM0ODgsLTE1ODIyMTE4NzcsLT
