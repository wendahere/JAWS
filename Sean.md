...
iv) After that, go to this [page] and download the file stated there. This will be the firmware that your ESP32 can use micropython. **Make sure you remeber where you save the file your going to path it later**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMDIxMzY4MTMsLTMzNTA2NDQxNSwtOT
