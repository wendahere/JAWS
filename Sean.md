...
5. The output of the Vout is always the voltage of one battery. **Thus, if you were to connect the negative terminal of the Vout of one module to a positive terminal of the Vout of another module, then the voltage would not add up and wil 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyODgyMjQxNTksLTIwMDk2MjE3NjEsLT
