...
Our group downloaded the firmware and also set up the wifi server on the ESP32 by ourselves on each of our personal blogs and ha
_placeholder text_
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA1MzMzMzAyNiwtMzY0NjE2MDEyLC0xMT
