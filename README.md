...
Our group downloaded the firmware and also set up the wifi server on the ESP3by ourselves on each of our blogs and ha
_placeholder text_
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NzExNTA5MDAsLTM2NDYxNjAxMiwtMT
