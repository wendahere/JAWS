...
iii) After that, type in the command ```esptool.py --port /dev/ttyUSB0 erase_flash``` if you are a mac user and ```esptool.py --porterase_flash```


<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAyNzY1MTAzNCw3MzAzNzA5OTksLTQ2OD
