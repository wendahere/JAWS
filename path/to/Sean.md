...
]([http://micropython.org/download#esp32](http://micropython.org/download#esp32))  download the file stated there. This will be the firmware that your ESP32 can use micropython. **Make sure you remeber where you save the file your going to path it later**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MzE1MjY4MSwxNjI0MzQ3NDUwLDE5OT
