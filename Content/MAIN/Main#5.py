...
pot = ADC(Pin(33)) #Voltage Divider pin
...
def servostop():
    servo = machine.PWM(machine.Pin(19), freq=0)  
    servo.duty(0)    
...
def servostop():
    servo = machine.PWM(machine.Pin(19), freq=100)  
    servo.duty(0)    
...
>>>>>>> b8c82bbf686d6a760782c7678706771416d83321
