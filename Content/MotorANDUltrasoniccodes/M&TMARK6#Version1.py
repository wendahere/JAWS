...
html = """<html><head><title>JAWS Controller</title><meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    .button2 {background-color: #4286f4;} .button6 {background-color: #4286f4; font-size: 10px; padding: 10px 24px;} .button7{background-color: #f44336; font-size: 10px; padding: 10px 24px;} .button8{background-color: #4286f4; font-size: 10px; padding: 10px 24px;}
